...
ALTER TABLE spool_items ADD COLUMN IF NOT EXISTS published_at TIMESTAMPTZ;
...
ALTER TABLE spool_items ADD COLUMN IF NOT EXISTS summary_text TEXT;
ALTER TABLE spool_items ADD COLUMN IF NOT EXISTS excerpt_text TEXT;
ALTER TABLE spool_items ADD COLUMN IF NOT EXISTS outbound_links_json JSONB DEFAULT '[]'::jsonb;

UPDATE spool_items
SET outbound_links_json = '[]'::jsonb
WHERE outbound_links_json IS NULL;
